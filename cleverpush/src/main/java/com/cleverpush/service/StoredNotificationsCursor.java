...
public class StoredNotificationsCursor {
  ...
  private void returnCombinedNotifications(NotificationsPageCallbackListener notificationsCallbackListener,
                                           Set<Notification> localNotifications,
                                           List<Notification> remoteNotifications) {
