...
/**
 * Process-wide {@link Instrumentation} wrapper that sees {@code onNewIntent} for every
 * host {@link Activity}, including those that do not extend ComponentActivity.
 */
  ...
  static void install() {
    synchronized (INSTALL_LOCK) {
      ...
      try {
        ...
        // Hidden API unavailable; ComponentActivity listener is the fallback.
      }
    }
  }
