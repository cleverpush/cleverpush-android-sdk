...
public class CleverPushPreferences {
  ...
  public static final String LAST_DEEP_LINK_URL = "CleverPush_LAST_DEEP_LINK_URL";
  public static final String LAST_DEEP_LINK_TIME = "CleverPush_LAST_DEEP_LINK_TIME";
